...
$content = function () use ($data) {
    ...
    if (!isset($event) || empty($event)) {
        echo '<div class="alert alert-info">Không tìm thấy sự kiện.</div>';
        return;
    }
?> <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <!-- Header -->
                <div class="card border-0 shadow mb-4 event-info-card">
                    <div class="card-header bg-info text-white py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2 class="mb-0 fs-4">
                                <i class="fas fa-heartbeat me-2"></i>Câu hỏi sàng lọc trước khi hiến máu
                            </h2>
                            <span class="badge bg-white text-info px-3 py-2">Bước quan trọng</span>
                        </div>
                    </div>
                    <div class="card-body p-4">
                        <div class="row mb-4">
                            <div class="col-md-8">
                                <h4 class="fw-bold mb-3"><?= htmlspecialchars($event['name'] ?? 'N/A') ?></h4>
                                <div class="d-flex flex-wrap gap-3 mb-3">
                                    <div class="d-flex align-items-center">
                                        <div class="icon-box bg-light rounded-circle p-2 me-2">
                                            <i class="far fa-calendar-alt text-info"></i>
                                        </div>
                                        <span><?= date('d/m/Y', strtotime($event['event_date'] ?? 'now')) ?></span>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <div class="icon-box bg-light rounded-circle p-2 me-2">
                                            <i class="far fa-clock text-info"></i>
                                        </div>
                                        <span><?= date('H:i', strtotime($event['event_start_time'] ?? 'now')) ?> -
                                            <?= date('H:i', strtotime($event['event_end_time'] ?? 'now')) ?></span>
                                    </div>
                                </div>
                                <div class="d-flex flex-wrap gap-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span><?= htmlspecialchars($event['donation_unit']['name'] ?? 'N/A') ?></span>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <div class="icon-box bg-light rounded-circle p-2 me-2">
                                            <i class="fas fa-map-marker-alt text-info"></i>
                                        </div>
                                        <span><?= htmlspecialchars($event['donation_unit']['address'] ?? 'N/A') ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 d-flex justify-content-center align-items-center">
                                ...
                                <?php else: ?>
                                    <div class="text-center">
                                        ...
                                        <h6 class="mb-0">Đơn vị hiến máu</h6>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>

                        <div class="alert alert-info d-flex border-start border-info border-4">
                            <div class="flex-shrink-0 me-3">
                                <i class="fas fa-info-circle fa-2x"></i>
                            </div>
                            <div>
                                <h5 class="alert-heading mb-1 fw-bold">Thông tin quan trọng</h5>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="age" name="age" min="18" max="60"
                                        required>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-3">
                                <label class="form-label">2. Bạn có đang uống thuốc kháng sinh hoặc thuốc khác không? <span
                                        class="text-info">*</span></label>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="taking_medicine"
                                        id="taking_medicine_yes" value="yes" required>
                                    <label class="form-check-label" for="taking_medicine_yes">Có</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="taking_medicine"
                                        id="taking_medicine_no" value="no">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="activity_none">Không có hoạt động nào ở
                                        trên</label>
                                </div>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">5. Nếu bạn là nữ, bạn có đang mang thai hoặc cho con bú không?
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="pregnancy" id="pregnancy_no"
                                        value="no">
                                    <label class="form-check-label" for="pregnancy_no">Không</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="pregnancy" id="pregnancy_na"
                                        value="na">
                            ...
                            <div class="mb-3">
                                <label class="form-label">6. Bạn có tiếp xúc với người mắc bệnh truyền nhiễm trong 14 ngày
                                    qua
                                    không? <span class="text-info">*</span></label>
                                <div class="form-check">
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="consent">
                                        ...
                                        việc hiến máu là hoàn toàn tự nguyện và tôi đồng ý với các quy trình hiến máu. Tôi
                                        đồng
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                form.addEventListener('submit', function(event) {
                    ...
                    const diseaseSelected = diseaseNone.checked || [...diseaseCheckboxes].some(checkbox =>
                        checkbox
                        .checked);
                    if (!diseaseSelected) {
                        event.preventDefault();

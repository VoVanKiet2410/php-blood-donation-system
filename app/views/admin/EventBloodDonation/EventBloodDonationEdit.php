...
$content = function () use ($event, $donationUnits) {
?>
        ...
        <div class="col-lg-8">
            ...
            <div class="ant-card hover-shadow">
                <div class="ant-card-body">
                    <form action="<?= BASE_URL ?>/index.php?controller=Event&action=adminUpdate&id=<?= $event->id ?>" method="POST" class="needs-validation" novalidate>
                        <!-- Event Name -->
                        <div class="ant-form-item">
                            ...
                            <input type="text" class="ant-input custom-input" id="name" name="name" value="<?= htmlspecialchars($event->name) ?>" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="ant-form-item">
                                    ...
                                    <input type="date" class="ant-input custom-input" id="eventDate" name="eventDate" value="<?= date('Y-m-d', strtotime($event->event_date)) ?>" required>
                            ...
                            <div class="col-md-4">
                                <div class="ant-form-item">
                                    ...
                                    <input type="time" class="ant-input custom-input" id="eventStartTime" name="eventStartTime" value="<?= date('H:i', strtotime($event->event_start_time)) ?>" required>
                            ...
                            <div class="col-md-4">
                                <div class="ant-form-item">
                                    ...
                                    <input type="time" class="ant-input custom-input" id="eventEndTime" name="eventEndTime" value="<?= date('H:i', strtotime($event->event_end_time)) ?>" required>
                            ...
                            <div class="col-md-6">
                                <div class="ant-form-item">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <input type="number" class="ant-input custom-input" id="maxRegistrations" name="maxRegistrations" value="<?= $event->max_registrations ?>" min="<?= $event->current_registrations ?>" required>
                                        <span class="badge bg-info-subtle text-info">
                                            Hiện tại: <?= $event->current_registrations ?>
                                        </span>
                                    </div>
                                ...
                                <div class="ant-form-item">
                                    ...
                                    <select class="ant-select custom-select" id="donationUnitId" name="donationUnitId" required>
                                        ...
                                        <?php foreach ($donationUnits as $unit): ?>
                                            <option value="<?= $unit->id ?>" <?= $event->donation_unit_id == $unit->id ? 'selected' : '' ?>>
                        ...
                        <div class="ant-form-item mb-4">
                            ...
                            <div class="ant-radio-group">
                                <label class="ant-radio-wrapper custom-radio">
                                    <input type="radio" name="status" value="1" class="ant-radio" <?= $event->status == 1 ? 'checked' : '' ?>>
                                    <span class="ant-radio-label">Hoạt động</span>
                                </label>
                                <label class="ant-radio-wrapper custom-radio ms-4">
                                    <input type="radio" name="status" value="0" class="ant-radio" <?= $event->status == 0 ? 'checked' : '' ?>>
                        ...
                        <!-- Last updated info -->
                        <div class="alert alert-light-purple mb-4">
                            <i class="fas fa-history me-1"></i>
                            Cập nhật lần cuối: <?= date('d/m/Y H:i:s', strtotime($event->updated_at)) ?>
                        </div>
            ...
            <div class="ant-card hover-shadow mb-4">
                ...
                <div class="ant-card-body">
                    ...
                    <div class="info-item d-flex justify-content-between mb-3 pb-3 border-bottom">
                        ...
                        <span class="fw-medium"><?= date('d/m/Y H:i', strtotime($event->created_at)) ?></span>
                    </div>
                    <!-- Registrations -->
                    <div class="info-item d-flex justify-content-between mb-3 pb-3 border-bottom">
                        ...
                        <span class="fw-medium">
                            ...
                            <?php 
                                $percentage = round(($event->current_registrations / $event->max_registrations) * 100);
                ...
                <div class="ant-card-body">
                    <div class="help-item mb-3 pb-3 border-bottom">
                        ...
                        <p class="text-muted small mb-0">
                            Việc thay đổi số lượng đăng ký tối đa chỉ có thể tăng, không thể giảm thấp hơn số lượng đăng ký hiện tại.
                        </p>
                    </div>
                    <div class="help-item mb-3 pb-3 border-bottom">
                        <div class="help-icon mb-2">
                    ...
                    <div class="help-item">
                        ...
                        <p class="text-muted small mb-0">
                            Nếu chuyển trạng thái sang "Không hoạt động", người dùng sẽ không thể đăng ký tham gia sự kiện này.
                        </p>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    maxRegistrationsInput.addEventListener('input', function() {
        if (parseInt(this.value) < currentRegistrations) {
            this.setCustomValidity(`Không thể đặt số lượng thấp hơn số đã đăng ký (${currentRegistrations})`);

                            ...
                            <td>
                                <?php
                                            if (isset($healthcheck['appointment']['appointment_date_time'])) {
                                                $date = date('d/m/Y', strtotime($healthcheck['appointment']['appointment_date_time']));
                                                $time = date('H:i', strtotime($healthcheck['appointment']['appointment_date_time']));
                                                $appointmentId = $healthcheck['appointment_id'] ?? '';
                                            ?>
                                <div>

                                    <div class="small text-muted">
                                        <i class="fas fa-calendar-alt me-1"></i><?= $date ?>
                                        <span class="ms-2"><i class="fas fa-clock me-1"></i><?= $time ?></span>
                                    </div>
                                </div>
                                <?php
                                            } else {

...
?>
    ...
    <div class="container-fluid px-0">
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="ant-card"
                    ...
                    <div class="ant-card-body">
                        ...
                        <form action="index.php?controller=Appointment&action=store" method="POST" class="needs-validation"
                            novalidate>
                            <!-- User Selection -->
                            <div class="ant-form-item mb-4">
                                <label for="user_cccd" class="ant-form-label"
                                ...
                                <select id="user_cccd" name="user_cccd" class="form-select custom-select" required>
                                    ...
                                    <?php foreach ($users as $user): ?>
                                        <option value="<?php echo htmlspecialchars($user['cccd']); ?>"
                                            <?php echo (isset($formData['user_cccd']) && $formData['user_cccd'] == $user['cccd']) ? 'selected' : ''; ?>>
                                            <?php echo htmlspecialchars($user['full_name']); ?>
                                            (<?php echo htmlspecialchars($user['cccd']); ?>)
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <!-- Event Selection -->
                            <div class="ant-form-item mb-4">
                                <label for="event_id" class="ant-form-label"
                                    style="color: var(--accent-blue); font-weight: 600;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="ant-form-item mb-4">
                                        <label for="appointment_date_time" class="ant-form-label"
                                            style="color: var(--accent-blue); font-weight: 600;">
                                        ...
                                        <input type="datetime-local" class="form-control custom-input"
                                            ...
                                            value="<?php echo isset($formData['appointment_date_time']) ? htmlspecialchars($formData['appointment_date_time']) : ''; ?>"
                                            required>
                                ...
                                <div class="col-md-6">
                                    <div class="ant-form-item mb-4">
                                        <label for="blood_amount" class="ant-form-label"
                                            style="color: var(--accent-blue); font-weight: 600;">
                                        ...
                                        <input type="number" class="form-control custom-input" id="blood_amount"
                                            ...
                                            value="<?php echo isset($formData['blood_amount']) ? htmlspecialchars($formData['blood_amount']) : '350'; ?>"
                                            required>
                                        <small class="form-text text-muted">Thông thường lượng máu hiến là từ 250ml đến
                                            450ml.</small>
                                        <div class="invalid-feedback">Lượng máu phải nằm trong khoảng từ 250ml đến 750ml.
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="status-options">
                                    <label class="status-option">
                                        <input type="radio" name="status" value="0"
                                            <?php echo (!isset($formData['status']) || $formData['status'] == '0') ? 'checked' : ''; ?>>
                                    ...
                                    <label class="status-option">
                                        <input type="radio" name="status" value="2"
                                            <?php echo (isset($formData['status']) && $formData['status'] == '2') ? 'checked' : ''; ?>>
                                        <span class="status-icon cancelled"><i class="fas fa-times-circle"></i></span>
                                        <span class="status-text">Đã hủy</span>
                                    </label>
                                    <label class="status-option">
                                        <input type="radio" name="status" value="3"
                                            <?php echo (isset($formData['status']) && $formData['status'] == '3') ? 'checked' : ''; ?>>
            ...
            <div class="col-lg-4">
                <div class="ant-card"
                    style="border: none; border-radius: 15px; background: linear-gradient(145deg, #f0f7ff, #e6f3ff); box-shadow: 0 10px 20px rgba(0, 123, 255, 0.1);">
                    ...
                    <div class="ant-card-body">
                        <div class="help-item mb-4 pb-3 border-bottom"
                            style="border-color: rgba(0, 123, 255, 0.2) !important;">
                            ...
                            <p class="text-muted mb-0 small">
                                Chọn đúng người hiến máu từ danh sách. Thông tin này sẽ được sử dụng để lưu kết quả hiến máu
                                sau này.
                            </p>
                        </div>
                        <div class="help-item mb-4 pb-3 border-bottom"
                        ...
                        <div class="help-item">
                            ...
                            <p class="text-muted mb-0 small">
                                Thông thường mỗi người sẽ hiến từ 250ml đến 450ml máu, phụ thuộc vào thể trạng và sức khỏe
                                của người hiến.
                            </p>
                        </div>
                    </div>

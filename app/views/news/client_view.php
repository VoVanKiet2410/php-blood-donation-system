        ...
        <div class="col-lg-8 mx-auto">
            <?php if (!$news): ?>
                <div class="text-center py-5">
                    ...
                    <a href="<?= BASE_URL ?>/public/index.php?controller=News&action=index" class="btn btn-outline-primary mt-3">
            ...
            <?php else: ?>
                ...
                <nav aria-label="breadcrumb" class="mb-4">
                    <ol class="breadcrumb">
                        <!-- <li class="breadcrumb-item"><a href="<?= BASE_URL ?>/public/index.php?controller=News&action=index">Trang chủ</a></li> -->
                        <li class="breadcrumb-item"><a href="<?= BASE_URL ?>/public/index.php?controller=News&action=index">Tin tức</a></li>
                ...
                <div class="mt-5 pt-4 border-top">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-md-end mt-3 mt-md-0">
                            <a href="<?= BASE_URL ?>/public/index.php?controller=News&action=index" class="btn btn-outline-secondary">
